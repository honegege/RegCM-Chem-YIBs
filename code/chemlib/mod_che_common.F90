...
!*****************************************************************************
  ...
  subroutine chem_config
    ...
    !@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@!
    ! xiaoxie modified    gaolb modified
      nbin = 4
      ntr = 67  !!! xie 50-->51  !gaolb 51-->67 = 51+16(SOA)
      allocate(chtrname(ntr))
      chtrname(1:ntr)(1:6) = (/'NO    ','NO2   ','N2O5  ','HNO2  ',&
                               ...
                               'ANO3  ','AOR1  ','AOR2  ','AOR3  ',&
                               'AOR4  ','BOR1  ','BOR2  ','BOR3  ',&
                               'BOR4  ','GAOR1 ','GAOR2 ','GAOR3 ',&
                               'GAOR4 ','GBOR1 ','GBOR2 ','GBOR3 ',&
                               'GBOR4 ','ANH4  ','CO2   '/) !!! xie
      iaerosol = 1
      igaschem = 1
      iisoropia = 1

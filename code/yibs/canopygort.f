...
!      endif
      ...
      !set values for debugging
        yibs_d%Resp_fol(cop%pft) = Resp_fol
        yibs_d%Resp_sw(cop%pft) = Resp_sw
        yibs_d%Resp_lab(cop%pft) = Resp_lab
        yibs_d%Resp_root(cop%pft) = Resp_froot
        yibs_d%Resp_maint(cop%pft) = Resp_maint
        yibs_d%Resp_growth_1(cop%pft) = Resp_growth_1
        yibs_d%Resp_growth(cop%pft) = Resp_growth

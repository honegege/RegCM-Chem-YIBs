...
!@sum Module  YIBS plant functional type (PFT) parameters for YIBS 16 PFTs default.
...
!     &     ,8.0d0               !Nleaf (gN/m2-leaf). Est. from Reich 1997 (big range).
     &     ,2.5d0),               !Nleaf (gN/m2-leaf). fort.995=read.table("../Code/GISSClim/GISSClim/WorkSpace/r_yibs_fbb_tnfg/fort.995", header=TRUE)

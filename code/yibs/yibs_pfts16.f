      module yibs_pfts
!@sum Parameter sets fo YIBS default supported 16 plant functional types.
...
!##### END OF TEMPORARY HACK #####
      ...
      !***************************************************
      !** Values for YIBS pfts with SIMARD HEIGHTS for late succ b1Ht ** - NK
     ...
     &     /)
      ...
      !-- Move a0h later from allometryfn.f when all yibs_pfts.f get updated.

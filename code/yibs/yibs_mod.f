...
!      integer, intent(in) :: jday
      ...
      !print*,'---------------before yibs integrate---------------'
      do i1=dims(1,1),dims(2,1)
      do i2=dims(1,2),dims(2,2)
      !print*,'I am in yibs integrate',i1,i2
        call yibs_integrate(dt, ycell(i1,i2)%ycell,update_day,config)
      
      enddo
      enddo
      !print*,'---------------end yibs integrate---------------'
...
!     &     soil_water,
     ...
     &         canopy_wet_fraction(i1,i2)
       if(isnan(ycell(i1,i2)%ycell%TairC)) print*,'nan tair'
       if(isnan(ycell(i1,i2)%ycell%TcanopyC)) print*,'nan TcanopyC'
       if(isnan(ycell(i1,i2)%ycell%Qf)) print*,'nan Qf'
       if(isnan(ycell(i1,i2)%ycell%P_mbar)) print*,'nan P_mbar'
       if(isnan(ycell(i1,i2)%ycell%Ca)) print*,'nan Ca'
       if(isnan(ycell(i1,i2)%ycell%O3s)) print*,'nan O3s'
       if(isnan(ycell(i1,i2)%ycell%Ch)) print*,'nan Ch'
       if(isnan(ycell(i1,i2)%ycell%U)) print*,'nan U'
       if(isnan(ycell(i1,i2)%ycell%IPARdif)) print*,'nan IPARdif'
       if(isnan(ycell(i1,i2)%ycell%IPARdir)) print*,'nan IPARdir'
       if(isnan(ycell(i1,i2)%ycell%CosZen)) print*,'nan CosZen'
       if(isnan(ycell(i1,i2)%ycell%fwet_canopy)) print*,'nan fwet'
       if(isnan(ycell(i1,i2)%ycell%TairC)) print*,'nan tair'
...
!          do n=1,N_CASA_LAYERS
     ...
     &           soil_ice_fraction(n,i1,i2)
       if(isnan(ycell(i1,i2)%ycell%Soiltemp(n))) print*,'nan Soiltemp'
       if(isnan(ycell(i1,i2)%ycell%Soilmoist(n))) print*,'nan smoist'
       if(isnan(ycell(i1,i2)%ycell%Soilmp(n))) print*,'nan Soilmp'
       if(isnan(ycell(i1,i2)%ycell%fice(n))) print*,'nan fice'
          enddo
...
C NADINE
     ...
     &     ycell_carbon( ycell(i1,i2)%ycell )
      ...
      subroutine yibs_struct_setup_r8_0(ycell,iu)
      use yibs_make_struct, only : yibs_struct_readcsv
      type(ycelltype_public),intent(inout) :: ycell 
      ...
      !---
        ...
        call yibs_struct_readcsv(ycell%ycell,iu)
      

      end subroutine yibs_struct_setup_r8_0

      subroutine yibs_struct_setup_r8_1(ycell,iu)
      use yibs_make_struct, only : yibs_struct_readcsv
      type(ycelltype_public),intent(inout) :: ycell (:)
      integer, intent(in) :: iu
      !---
      ...
      do i1=dims(1,1),dims(2,1)
        call yibs_struct_readcsv(ycell(i1)%ycell,iu)
      
      enddo

      end subroutine yibs_struct_setup_r8_1

      subroutine yibs_struct_setup_r8_2(ycell,iu)
      use yibs_make_struct, only : yibs_struct_readcsv
      type(ycelltype_public),intent(inout) :: ycell (:,:)
      integer, intent(in) :: iu
      !---
      ...
      do i1=dims(1,1),dims(2,1)
      do i2=dims(1,2),dims(2,2)
        call yibs_struct_readcsv(ycell(i1,i2)%ycell,iu)
      
      enddo
      enddo

      end subroutine yibs_struct_setup_r8_2




      subroutine yibs_struct_initphys_cells_r8_0(ycell,
     &     soil_texture,
!     &     pft_soil_type,
!     &     vegalbedo,
...
!      real*8, dimension(:,:)  ::  vegalbedo ! dim=N_COVERTYPES, n
     ...
     &     Ci_ini, CNC_ini, Tcan_ini, Qf_ini
      ...
      !---
        ...
        if ( associated(ycell%ycell) ) then
!      if ( .not. associated(ecp) ) 
!     &      call stop_model("yibs_struct_initphys_cells 1",255)
          !call ycell_print(6,ycell%ycell)

	  call assign_ycell( ycell%ycell,
!     &	       vegalbedo(:,:),
     &         soil_texture(:),
!     &         pft_soil_type(:),
     &         Ci_ini, CNC_ini,
     ...
     &         reinitialize)
      ...
      end subroutine yibs_struct_initphys_cells_r8_0

      subroutine yibs_struct_initphys_cells_r8_1(ycell,
     &     soil_texture,
!     &     pft_soil_type,
!     &     vegalbedo,
     &     Ci_ini, CNC_ini, Tcan_ini, Qf_ini, 
...
!     &      call stop_model("yibs_struct_initphys_cells 1",255)
	  ...
	  call assign_ycell( ycell(i1)%ycell,
!     &	       vegalbedo(:,:,i1),
     &         soil_texture(:,i1),
!     &         pft_soil_type(:,i1),
     &         Ci_ini(i1), CNC_ini(i1),
     ...
     &         reinitialize)
      ...
      end subroutine yibs_struct_initphys_cells_r8_1

      subroutine yibs_struct_initphys_cells_r8_2(ycell,
     &     soil_texture,
!     &     pft_soil_type,
!     &     vegalbedo,
     &     Ci_ini, CNC_ini, Tcan_ini, Qf_ini, 
...
!     &      call stop_model("yibs_struct_initphys_cells 1",255)
	  ...
	  call assign_ycell( ycell(i1,i2)%ycell,
!     &	       vegalbedo(:,:,i1,i2),
     &         soil_texture(:,i1,i2),
!     &         pft_soil_type(:,i1,i2),
     &         Ci_ini(i1,i2), CNC_ini(i1,i2),
     ...
     &         reinitialize)
      ...
      end subroutine yibs_struct_initphys_cells_r8_2

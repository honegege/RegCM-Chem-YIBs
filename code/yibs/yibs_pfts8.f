      module yibs_pfts
!@sum Parameter sets for GISS 8 vegetation biome types for YIBS model.
      ...
      !***************************************************
      !Types: These are GISS GCM types until we get full data sets for YIBS.
...
*            Check for:  sla, lrage, woodage, albedo
      !*-----------------------------------------
      !For dependencies to work, these constants must go in yibs_const.f

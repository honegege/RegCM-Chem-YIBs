...
!                                                           woody biomass to LAI
     ...
     &   19.01d0, 16.38d0, 0.79d0, 1.26d0, 1.00d0/)       ! inital canopy height (m)
...
!                                                           (kg C/ m2 leaf)
     ...
     &   0.02d0, 0.02d0,  0.20d0,  0.20d0,  0.10d0/)      ! Turnover rate for woody biomass (/360days)
...
!                                                           with moisture avaialbity
     ...
     &   0.40d0,  0.75d0,  1.00d0,  1.00d0,  0.40d0/)     ! Ratio of root nitrogen concentration to
!                                                           leaf nitrogen concentration

      real*8, dimension(nt_pft), parameter :: ns_nl = (/
     &   0.05d0,  0.05d0,  1.00d0,  1.00d0,  0.05d0/)     ! Ratio of stem nitrogen concentration to
!                                                           leaf nitrogen concentration
...
c      if (config%do_init_activegrowth) then
c         call init_yibs_growth(pp)
c         config%do_init_activegrowth = .false.
c      endif
      ht_spinup = .false. !!! xiaoxie add

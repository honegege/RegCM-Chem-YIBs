...
!      integer :: N_DEPTH        !Number of soil layers.  SET IN YIBS_INIT
      !!! xiaoxie 2018-12-27
c      integer, parameter :: N_DEPTH = 6 ! use yibs data
c      real*8, parameter :: SOILDEPTH_m(N_DEPTH) = !Bottom depths of
c     &     (/ 0.1,0.27,0.57,1.08,1.97,3.5 /) !GISS GCM
      integer, parameter :: N_DEPTH = 10 ! use clm data from regcm 
      real*8, parameter :: SOILDEPTH_m(N_DEPTH) = !Bottom depths of soil layers (m)
     &     (/ 0.00710064,0.027925,0.0622586,0.118865,0.212193,
     &     0.366066,0.619758,1.03803,1.72764,2.86461/) !GISS GCM
